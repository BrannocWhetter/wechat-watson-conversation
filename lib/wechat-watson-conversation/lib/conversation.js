...
module.exports = (app, config) => {
  ...
  // use JSON.stringify to send the sessionId? Since sessionId from export returns NaN at the moment...
  console.error('SessionID from Conversation.js: %d', sessionId);
...
// New content to test pulling sessionId from session storage.
/*
